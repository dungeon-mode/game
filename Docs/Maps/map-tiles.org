...
|      |                                                             |                                     |          |
| C2   | <text x="1.85" y="1.65" font-size=".5" fill="blue">C</text> | Mark 30x40 Compulsion with C        |          |
|      | <text x=".4" y=".25" font-size=".35" fill="blue">1</text>   |                                     |          |
|      | <text x="3.8" y="1.6" font-size=".35" fill="blue">2</text>  |                                     |          |
|      | <text x="2.45" y="2.9" font-size=".35" fill="blue">3</text> |                                     |          |
|      | <text x="1.35" y="2.9" font-size=".35" fill="blue">4</text> |                                     |          |
|      | <text x=".05" y="2.6" font-size=".35" fill="blue">5</text>  |                                     |          |
|      | <text x=".05" y=".6" font-size=".35" fill="blue">6</text>   |                                     |          |
