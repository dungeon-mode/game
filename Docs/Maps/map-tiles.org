...
|      |                                                           |                                     |          |
| C2   | <text x="1.3" y="2.65" font-size=".5" fill="red">C</text> | Mark 30x40 Compulsion with C        |          |
|      | <text x=".25" y=".65" font-size=".5" fill="red">1</text>  |                                     |          |
|      | <text x=".25" y=".65" font-size=".5" fill="red">1</text>  |                                     |          |
|      |                                                           |                                     |          |
=======
| Tile | Overlay                                                    | Documentation                       | Behavior |
...
| F3   | <text x="1.3" y="1.65" font-size=".5" fill="red">F</text>  | Mark 30x30 Fountain with a text tag |          |
|      |                                                            |                                     |          |
| C2   | <text x="1.85" y="1.65" font-size=".5" fill="red">C</text> | Mark 30x40 Compulsion with C        |          |
|      | <text x=".25" y=".65" font-size=".25" fill="blue">1</text> |                                     |          |
|      | <text x=".25" y=".65" font-size=".25" fill="blue">2</text> |                                     |          |
|      | <text x=".25" y=".65" font-size=".25" fill="blue">3</text> |                                     |          |
|      | <text x=".25" y=".65" font-size=".25" fill="blue">4</text> |                                     |          |
|      | <text x=".25" y=".65" font-size=".25" fill="blue">5</text> |                                     |          |
|      | <text x=".15" y=".65" font-size=".25" fill="blue">6</text> |                                     |          |
>>>>>>> 2f2ea7266a91d76f7e3e6d62cd302ced673d282d
...
|------------+----------------------------------------------------------------+-----------------------------------+-------------------------------------------------------------------------|
| GS         | ‡W ‡N → ‡N ‡E ↘ ‡N ‡E ↓ ‡E ↓ ‡E ‡S ← ‡S ← ← ‡S ‡W ↑ ‡W ↑ ‡W ‡N | General Store                     | <text x="-.65" y="2.25" font-size=".6" fill="blue">General Store</text> |
|            |                                                                |                                   |                                                                         |
| throneroom | ‡W ‡N → ‡N → ‡N → ‡N ‡E ↓ ‡E ↓ ‡E ‡S ← ‡S ← ‡S ← ‡S ‡W ↑ ◦W    | The Throne Room                   | <text x=".5" y="1.75" font-size=".6" fill="blue">Throne Room</text>     |
|            |                                                                |                                   |                                                                         |
