...
This is the main "README" document for the dungeon-mode project.  This license statement applies to this file as well as any and all other files included in the authoritative source repository (HTTPS://github.org/dungeon-mode/game) which do not contain their own license.
