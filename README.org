...
#+BEGIN_QUOTE
TL;DR We are actively but slowly working on this.

We welcome your interest and participation!

We are doing analysis and head-first conceptual development to create
a Minimum Play-Testable Product (MPTP).
#+END_QUOTE

Please open an issue to request commit access or share your thoughts.

More both general and detailed status in [[Community and Outreach][Community and Outreach]], below.
